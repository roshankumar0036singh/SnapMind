...
async def test_kb_stats():
    ...
    from snapmind_mcp.resources.kb import read_kb_stats
...
async def test_kb_tags():
    ...
    from snapmind_mcp.resources.kb import read_kb_tags
...
async def test_kb_sites():
    ...
    from snapmind_mcp.resources.kb import read_kb_sites
