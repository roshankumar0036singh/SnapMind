...
export default function ExtensionPage() {
  const features = [
    ...
    {
      icon: <BookMarked className="h-6 w-6 text-primary-400" />,
  ...
  return (
    <main className="min-h-screen bg-[#0b0f19] text-white pb-20 selection:bg-primary-500 selection:text-white">
      ...
      <div className="absolute top-0 left-0 w-full h-[600px] bg-gradient-to-b from-[#112440]/30 via-transparent to-transparent pointer-events-none z-0" />
      ...
      <div className="wrapper max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <a
              ...
              className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white font-bold transition-all hover:scale-105 shadow-lg shadow-sky-500/10 hover:shadow-sky-500/20"
            >
        ...
        <div className="max-w-4xl mx-auto mb-20">
          <div className="relative rounded-2xl border border-gray-800 bg-gray-950/60 p-4 shadow-2xl backdrop-blur-md">
            {/* Window controls */}
            <div className="flex items-center gap-1.5 border-b border-gray-800/80 pb-3 mb-4">
            ...
            <div className="grid md:grid-cols-[1fr_260px] gap-4 min-h-[300px]">
              <div className="p-6 bg-gray-900/40 rounded-xl border border-gray-800/60 flex flex-col justify-between">
                <div>
                  <h4 className="text-lg font-bold text-white mb-2">Workspace Ingestion</h4>
                  <p className="text-gray-400 text-sm leading-relaxed mb-4">
                    Instantly save current tabs, bookmark selected blocks, or pin URLs to your active notebooks.
                  </p>
                </div>
                <div className="flex items-center gap-2 text-xs text-gray-400 bg-gray-950 px-3 py-2 rounded border border-gray-800 w-fit">
              ...
              <div className="p-4 bg-gray-900 border border-gray-800 rounded-xl flex flex-col gap-4">
                <div className="text-xs font-bold text-gray-400 tracking-wider uppercase border-b border-gray-800 pb-2">
                  SnapMind Sidebar
                </div>
                <div className="space-y-3">
                  <div className="p-2.5 rounded bg-gray-950 border border-gray-800 text-xs">
                    <span className="font-semibold text-primary-400 block mb-1">Search Context</span>
                    <span className="text-gray-500 block line-clamp-2">"Find other research documents describing BM25 hybrid search algorithms..."</span>
                  </div>
                  <div className="p-2.5 rounded bg-gray-950 border border-gray-800 text-xs">
                    <span className="font-semibold text-primary-400 block mb-1">Visual QA</span>
                    <span className="text-gray-500 block line-clamp-2">"Identify diagram nodes from the currently loaded page screenshot..."</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {features.map((feat, i) => (
            <div key={i} className="p-6 rounded-2xl bg-gray-900/40 border border-gray-800 hover:border-sky-500/30 transition-all flex gap-4">
              <div className="h-10 w-10 rounded-lg bg-sky-500/10 flex items-center justify-center text-sky-400 shrink-0">
                {feat.icon}
              </div>
              <div>
