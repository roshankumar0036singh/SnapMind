...
import { Terminal, Shield, Cpu, Zap, Settings, HelpCircle, Code, Layers, FileText, ArrowRight } from 'lucide-react';
...
export default function McpPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0b0f19] text-white pb-20 selection:bg-primary-500 selection:text-white">
      {/* Background Gradients */}
      <div className="absolute top-0 left-0 w-full h-[600px] bg-gradient-to-b from-[#1b153f]/25 via-transparent to-transparent pointer-events-none z-0" />
      ...
      <div className="wrapper max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 relative z-10">
        ...
        <div className="max-w-4xl mx-auto mb-20">
          <h2 className="text-2xl font-bold mb-8 text-center text-white">Choose Setup Method</h2>
          ...
          <div className="space-y-8">
            ...
            <div className="p-6 rounded-2xl bg-gray-900/40 border border-gray-800">
              <div className="flex items-center gap-3 mb-4">
                <span className="flex items-center justify-center h-8 w-8 rounded-lg bg-primary-500/20 text-primary-400 font-bold text-sm">
                  1
                </span>
                <h3 className="text-xl font-bold text-white">Global Installation (Recommended)</h3>
              </div>
              <p className="text-gray-400 text-sm mb-6 leading-relaxed">
                The easiest way to use SnapMind with Claude Desktop is via <code>uvx</code> or <code>npx</code>, which pulls directly from PyPI. Add this code block to your <code>claude_desktop_config.json</code> file:
              </p>
              <div className="relative rounded-xl border border-gray-800 bg-gray-950 p-4 font-mono text-xs text-gray-300 overflow-x-auto leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-gray-900/40 border border-gray-800">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-white">Installation via Smithery</h3>
              </div>
              <p className="text-gray-400 text-sm mb-6 leading-relaxed">
                Install SnapMind for Claude Desktop or other MCP clients automatically using Smithery:
              </p>
              <div className="max-w-xl p-1.5 bg-gray-950 rounded-xl border border-gray-800 flex items-center justify-between gap-4">
            ...
            <div className="p-6 rounded-2xl bg-gray-900/40 border border-gray-800">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-white">Manual Local Installation</h3>
              </div>
              <p className="text-gray-400 text-sm mb-4 leading-relaxed">
                1. Clone the repository and navigate to the <code>mcp-server</code> directory:
              </p>
              <div className="max-w-xl p-1.5 bg-gray-950 rounded-xl border border-gray-800 flex items-center justify-between gap-4 mb-4">
                <div className="flex items-center gap-3 pl-3 text-sm text-gray-300 font-mono">
                  <Terminal className="h-4 w-4 text-primary-500" />
        ...
        <div className="max-w-5xl mx-auto mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {toolCategories.map((cat, i) => (
              <div key={i} className="p-6 rounded-2xl bg-gray-900/30 border border-gray-800/80">
                <h3 className="text-lg font-bold text-primary-400 border-b border-gray-800 pb-3 mb-4">
                  {cat.title}
                </h3>
                <div className="space-y-4">
                  {cat.tools.map((t, idx) => (
                    <div key={idx} className="flex gap-3 items-start">
                      ...
                      <div>
                        <code className="text-xs font-mono font-bold text-white bg-gray-900 px-1.5 py-0.5 rounded border border-gray-800">
                          {t.name}
                        </code>
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="p-6 rounded-2xl bg-gray-900/20 border border-gray-800">
            <h3 className="text-lg font-bold text-white mb-4">📚 Available Resources</h3>
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex items-start gap-2">
                <code className="text-xs text-violet-400 bg-gray-950 px-1 py-0.5 rounded font-mono">snapmind://kb/stats</code>
                <span>Live knowledge base statistics</span>
              </li>
              <li className="flex items-start gap-2">
                <code className="text-xs text-violet-400 bg-gray-950 px-1 py-0.5 rounded font-mono">snapmind://kb/tags</code>
                <span>All semantic tags</span>
              </li>
              <li className="flex items-start gap-2">
                <code className="text-xs text-violet-400 bg-gray-950 px-1 py-0.5 rounded font-mono">snapmind://kb/sites</code>
                <span>Indexed source URL catalog</span>
              </li>
              <li className="flex items-start gap-2">
                <code className="text-xs text-violet-400 bg-gray-950 px-1 py-0.5 rounded font-mono">snapmind://graph/full</code>
          ...
          <div className="p-6 rounded-2xl bg-gray-900/20 border border-gray-800">
            <h3 className="text-lg font-bold text-white mb-4">🗣️ Prompt Templates</h3>
            ...
            <div className="flex flex-wrap gap-2">
              {['research_topic', 'code_review', 'summarize_notebook', 'deep_dive', 'compare_sources', 'export_knowledge'].map((p, idx) => (
                <span key={idx} className="px-2.5 py-1 rounded bg-gray-950 text-xs font-mono border border-gray-800 text-gray-300">
                  {p}
                </span>
              ))}
            </div>
