...
import { useState } from 'react';
  ...
  const testimonials = [
    ...
    },
    {
      ...
      image: '/images/users/user-1.png',
      testimonial:
        "SnapMind's browser extension seamlessly integrates with my workflow, allowing me to ingest live webpages into my vector DB in seconds.",
    },
    {
      id: 8,
      name: 'Darlene Robertson',
      ...
      image: '/images/users/user-2.png',
      testimonial:
        "The cross-encoder reranking ensures that I always get the most relevant context retrieved from my massive library of documents.",
    },
    {
      id: 9,
      name: 'Devon Lane',
      ...
      image: '/images/users/user-3.png',
      testimonial:
        "Groq Vision analysis allows me to extract text and analyze diagrams directly from screenshots. Simply amazing.",
    },
  ];
