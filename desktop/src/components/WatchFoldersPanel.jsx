    ...
    <div className="bg-[#121214] border border-[#27272a] rounded-xl overflow-hidden mb-6">
      <div className="px-6 py-5 border-b border-[#27272a] flex items-center justify-between bg-[#18181b]/50">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-[#fafafa] hover:bg-[#22c55e] text-[#09090b] text-[10px] font-black uppercase tracking-widest rounded-lg transition-all hover:shadow-[0_0_20px_rgba(34,197,94,0.3)] active:scale-95"
        >
        ...
        {folders.length === 0 ? (
          ...
          <ul className="grid grid-cols-1 gap-4">
            {folders.map((folder, idx) => (
              <li key={idx} className="flex items-center justify-between p-4 rounded-xl border border-[#27272a] bg-[#18181b] hover:border-[#22c55e]/30 transition-all group">
                <div className="flex items-start gap-4 overflow-hidden">
                  <div className="w-8 h-8 rounded-lg bg-[#27272a] group-hover:bg-[#22c55e]/10 flex items-center justify-center transition-colors">
                    <ShieldCheck className="w-4 h-4 text-[#3f3f46] group-hover:text-[#22c55e]" />
                  </div>
                ...
                <div className="flex items-center gap-4 ml-4 flex-shrink-0">
                  <div className="flex items-center gap-2 text-[9px] font-black text-[#22c55e] bg-[#22c55e]/10 border border-[#22c55e]/20 px-2 py-1 rounded">
